import { SET_USER, SIGN_UP,SIGN_IN, ACTIVATE, GET_USER, LOG_OUT, RESET_PASSWORD } from "../action-types/user-action-types";
import { IUserData, IAuthorizeData, ISignIn, ITokens } from '../../type';
